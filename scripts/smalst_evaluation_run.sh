# Example script to run the evaluation
 ...
 python -m smalst.smal_eval --name=smal_net_test --img_path='/user/work/gh18931/diss/datasets/zebra_testset/' --num_train_epoch=130 --use_annotations=True --mirror=True --segm_eval=True --img_ext='.jpg' --anno_path='/user/work/gh18931/diss/datasets/zebra_testset/annotations'
